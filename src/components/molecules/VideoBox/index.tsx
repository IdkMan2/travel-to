...
function VideoBox(props: IVideoBoxProps) {
  const {source, children, VideoProps, SourceProps} = props;
  let {classes} = props;
  classes = {...useStyles(), ...classes};

  return (
    <header className={classes.root}>
      <video autoPlay muted loop className={classes.video} {...VideoProps}>
        <source src={source} type={'video/mp4'} {...SourceProps} />
